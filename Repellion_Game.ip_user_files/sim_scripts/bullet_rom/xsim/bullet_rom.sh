...
#
# Generated by Vivado on Thu Mar 17 13:08:47 -0400 2022
...
# Script info
echo -e "bullet_rom.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bullet_rom xil_defaultlib.bullet_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bullet_rom -key {Behavioral:sim_1:Functional:bullet_rom} -tclbatch cmd.tcl -log simulate.log
}
